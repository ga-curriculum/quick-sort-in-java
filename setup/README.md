...
Name the project `quick-sort-in-java`.
...
After confirming that the **New Project** window looks similar to the screenshot below, select the **Create** button. The name of the project should be `quick-sort-in-java`, not `untitled`.
